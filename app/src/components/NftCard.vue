...
const nft = ref(props.nftData.nftMetadata);
const imageAccount = ref(props.nftData.imageAccount);
const img = ref("");
...
<template>
	<div class="relative">
		...
		<img
			v-if="imageAccount.availability == 'Private'"
			:src="lock"
			class="!w-[1.5rem] !h-auto absolute top-[15px] right-[15px]"
		/>
	</div>
</template>
